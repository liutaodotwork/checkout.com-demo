...
jQuery(document).ready(function($) {
  ...
  //---------------------------------------------------------
	...
	//------------------------------------------------------------------------------
	var $categorySortingOptions = $('.category-sorting-options');
	if($categorySortingOptions.length) {
        $categorySortingOptions.on('change', function () {
            var url = $(this).val();
            if (url) {
                window.location = url;
            }
	...
	// Sku selector on product page
	//------------------------------------------------------------------------------
	var $skuSelector = $('.sku-selector');
	...
	//------------------------------------------------------------------------------
	var $signInUpBtn = $('.sign-in-up-btn');
	if($signInUpBtn.length) {
        $signInUpBtn.on('click', function () {
            $("#modal-login").modal('show');

            var url = $(this).attr('data-dest');
            if (url) {
	...
	//------------------------------------------------------------------------------
	var $shippingAddressBtn = $('.shipping-address-btn');
	if($shippingAddressBtn.length) {
        $shippingAddressBtn.on('click', function () {
	...
	// Open payment page modal
	//------------------------------------------------------------------------------
	var $paymentPageBtn = $('.payment-btn');
	if($paymentPageBtn.length) {
        $paymentPageBtn.on('click', function () {
            $("#modal-payment-page").modal('show');
